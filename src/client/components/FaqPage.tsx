          ...
          <Accordion flush id='faq-accordion' activeKey={hash} onSelect={onSelect}>
            ...
            <section id='other'>
              ...
              <Accordion.Item eventKey='#contact'>
                ...
                <Accordion.Body>
                  <ol>
                    <li>You can report bugs, request new features, suggest documentation improvements, or let us know about new/changed projects by <a href="https://github.com/Inexorable-Fate/mpc_projects/issues/new/choose">filing an issue on Github.</a></li>
                    <li>Not a GitHub person? Or just need someone to refresh a project? The best way to get in touch with us is in the dedicated <a href="https://discord.com/channels/225349059689447425/1192620482168635523">forum section</a> for Inexorable Fate and the MPC Project Helper on ther Mythos Busters Discord server. Find us there for support or dev chat.</li>
                    <li>The dev forum is the recommended method of contact, but if for some reason that doesn&rsquo;t work for you, you can also find Coldtoes (she/her), in rough order of preference, as <a href='https://discord.com/users/10coldtoes'>10coldtoes</a> on Discord, as <a href='https://www.reddit.com/user/coldt0es'>u/coldt0es</a> on <a href='https://www.reddit.com/r/arkhamhorrorlcg/'>r/arkhamhorrorlcg</a>, and as <a href='https://boardgamegeek.com/user/coldtoes'>coldtoes</a> on BoardGameGeek. But YMMV in how fast she gets back to you with these methods.</li>
                  </ol>
                </Accordion.Body>
              </Accordion.Item>
            </section>
